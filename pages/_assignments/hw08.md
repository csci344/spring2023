...
>
> ## Academic Integrity
> This homework assignment has subtle differences from the one we released last quarter. Consulting or submitting code from a past version of this course is not acceptable, and we will be running MOSS to promote academic integrity. If you're lost or stuck and feel tempted to refer to old solutions, don't. Instead, talk to us and use your late days. Sarah and the course staff are here to help! 
...
Before you get into the concepts and code, let's first download and configure the hw08 files. Please complete the following steps:

### 1. Configure your local git repo
Before making any changes to your `photo-app` folder, let's create a `hw02` branch and a `hw08` branch using git:

1. On your terminal or command line, navigate to your photo-app folder (from HW2).
1. First create a `hw02` branch to save your `hw02` work in a convenient, named branch as follows: `git checkout -b hw02`
1. Push your `hw02` branch to GitHub as follows: `git push -u origin hw02`. This will make it easy for you to preview your work from Homework 2 if you want to revisit it.
1. Next, create a branch called hw08 as follows: `git checkout -b hw08`
1. Now type `git branch` and you should see that there are at least 3 branches: `main`, `hw02`, and `hw08`. Also note that you are currently on the `hw08` branch (it should be green with an asterik next to it).
1. Push your `hw08` branch to GitHub as follows: `git push -u origin hw08`
1. Open GitHub repo in your web browser and verify that you now have a `hw02` and a `hw08` branch is on GitHub.

### 2. Copy the HW3 files into your photo-app

Download hw08.zip and unzip it. 

<a class="nu-button" href="/spring2023/course-files/homework/hw08.zip">hw08.zip<i class="fas fa-download" aria-hidden="true"></i></a>
...
Move all of the `hw08` files into the root of your `photo-app` directory. It's OK to replace your existing files (since you've already committed them to the `hw02` branch).
...
<img class="large frame" src="/spring2023/assets/images/homework/hw08/api_tester.png" />

This UI can help you test your API (as can the automated tests and Postman).

#### 3. Run the automated test suite
From a new terminal / shell window, navigate into the `photo-app/tests` and run the test suite **while Flask is running**. In other words, you will have 2 terminals open: one that's running flask and one that's for the test suite:

<img class="small frame" src="/spring2023/assets/images/homework/hw08/shell-run-flask.png" />

<img class="small frame" src="/spring2023/assets/images/homework/hw08/shell-run-tests.png" />
...
The test suite should run 62 tests. You should see a bunch of error messages output to the screen with a summary at the bottom telling you that there were 44 failures and 11 errors (and 7 successes :).
...
When you're done inspecting this file, please open Postman to test one of the `Post` endpoints.
...
<img class="large frame" src="/spring2023/assets/images/homework/hw08/postman-before.png" />
...
The links included below point to a deployment of the hw08 solutions.
<table>
    <thead>
        <tr>
            <th>Method/Route</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li><a href="https://photoapp-spring.herokuapp.com/api/followers">/api/followers</a></li>
                </ul>
            </td>
            <td></td>
        ...
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li><a href="https://photoapp-spring.herokuapp.com/api/following">/api/following</a></li>
                </ul>
            </td>
            <td></td>
        ...
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li><a href="https://photoapp-spring.herokuapp.com/api/profile">/api/profile</a></li>
                </ul>
            </td>
            <td></td>
            <td>User object</td>
        ...
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li><a href="https://photoapp-spring.herokuapp.com/api/suggestions">/api/suggestions</a></li>
                </ul>
            </td>
            <td></td>
        ...
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li><a href="https://photoapp-spring.herokuapp.com/api/stories">/api/stories</a></li>
                </ul>
            </td>
            <td></td>
        ...
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li><a href="https://photoapp-spring.herokuapp.com/api/bookmarks">/api/bookmarks</a></li>
                </ul>
            </td>
            <td></td>
...
<img class="frame xsmall" src="/spring2023/assets/images/homework/hw08/heroku1.png" />

<img class="large frame" src="/spring2023/assets/images/homework/hw08/heroku2.png" />
...
<img class="small frame" src="/spring2023/assets/images/homework/hw08/heroku6a.png" />

Next, search for the app you just made and then click "Submit Order Form"

<img class="large frame" src="/spring2023/assets/images/homework/hw08/heroku6b.png" />

<img class="large frame" src="/spring2023/assets/images/homework/hw08/heroku7.png" />

When you're done, you should see a confirmation screen:

<img class="large frame" src="/spring2023/assets/images/homework/hw08/heroku8.png" />

#### 3. Add Database Environment Variables

Now navigate to the "Settings" tab:

<img class="large frame" src="/spring2023/assets/images/homework/hw08/heroku9.png" />

Scroll down and click the "Reveal Config Vars"

<img class="medium frame" src="/spring2023/assets/images/homework/hw08/heroku10.png" />
...
<img class="large frame" src="/spring2023/assets/images/homework/hw08/heroku11.png" />
...
<img class="large frame" src="/spring2023/assets/images/homework/hw08/heroku12.png" />
...
1. Navigate to your `photo-app` folder (using the command line)
1. Log into your Heroku account using the command line interface (CLI), where you will be prompted for a password:<br>`heroku login -i`
...
1. Push your repo to Heroku: `git push heroku hw08:main`, where `hw08` is the name of your local branch, and `main` is the name of the destination branch on Heroku. 
