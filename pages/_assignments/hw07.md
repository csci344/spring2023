...
## Overview
For your last homework assignment, you will re-implement your HW5 & HW6 code in way that follows React conventions. A few ground rules:
...
1. There is some starter code for this homework in [Tutorial 8](tutorial08) that you are welcome to use. That said, you are also welcome to code this assignment from scratch -- up to you.
