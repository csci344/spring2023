...
<table style="border-width:0px;">
    <tr>
        <td>
            <img class="large frame" src="/spring2023/assets/images/tutorials/tutorial12/img1.png" />
            <p>HTTP Protocol (http:// or https://)</p>
        </td>
        <td>
            <img class="large frame" src="/spring2023/assets/images/tutorials/tutorial12/img2.png" />
...
<a class="nu-button" style="margin-top:20px;display:inline-block;" href="/spring2023/course-files/tutorials/tutorial12.zip">tutorial12.zip<i class="fas fa-download" aria-hidden="true"></i></a>
...
<img class="large frame" style="width:100%;" src="/spring2023/assets/images/tutorials/tutorial12/live-demo.gif" />
...
<img class="large frame" style="width:100%;" alt= "animated image of the instructions described above" src="/spring2023/assets/images/tutorials/tutorial12/mac-voiceover-open.gif" />

#### Turn off VoiceOver
Click the X on the top left of the gray VoiceOver transcription box
<img class="large frame" style="width:100%;" alt= "animated image of the instructions described above" src="/spring2023/assets/images/tutorials/tutorial12/mac-voiceover-close.gif" />

### Windows Narrator Instructions
#### Turn on Narrator
Open the Start menu, search for Narrator, enable and **do not close** the Narrator window
<img class="large frame" style="width:100%;" alt= "animated image of the instructions described above" src="/spring2023/assets/images/tutorials/tutorial12/windows-narrator-open.gif" />    
...
<img class="large frame" style="width:100%;" alt= "animated image of the instructions described above" src="/spring2023/assets/images/tutorials/tutorial12/windows-narrator-close.gif" />    
...
<img class="large frame" src="/spring2023/assets/images/tutorials/tutorial12/img3.png" />
