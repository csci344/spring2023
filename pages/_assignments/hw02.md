...
> For this homework, you are welcome to work in pairs (optional). Even if you collaborate with someone else, you must still submit your HTML and CSS files on Moodle. You may share a GitHub repository or you can each create your own GitHub repository. If you collaborate, you'll just list your partner in the comments section of Moodle. 
> 
