...
<a class="nu-button" href="/spring2023/course-files/homework/hw09.zip">hw09.zip<i class="fas fa-download" aria-hidden="true"></i></a>
...
<table class="rubric-indent">
    ...
    "access_token": "e0e.Ras.i3NyZ"
        ...
        <tr>
            ...
            <td>app.py</td>
            <td>
               Deprecate <code>app.current_user</code> (which is hardcoded to User #12) and use the user_id embedded in the JWT instead. See <a href="#note">note below</a>.
            </td>
            <td></td>
            <td>5</td>
        </tr>
...
2. Adding the `@jwt.user_lookup_loader` decorator to the top of the function. By doing this, you can use the built-in `flask-jwt-extended.current_user` property to access the logged in user (works like magic).
